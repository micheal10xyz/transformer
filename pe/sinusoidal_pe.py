...
class SinusoidalPE(nn.Module):
    def __init__(self, dim, max_len=1000):
        ...
        base = 10000
        base_pow = torch.pow(base, torch.arange(0, dim, 2, dtype=torch.float16) / dim).unsqueeze(0)
    ...
    def forward(self, X: torch.Tensor):
        ...
        """
        return X + torch.unsqueeze(self.pe[0:X.shape[1], ::], dim=0)
    



# pe = SinusoidalPE(256, 50)
# plt.figure(figsize=(10,6))
# plt.imshow(pe.pe.numpy(), cmap='viridis', aspect='auto')
